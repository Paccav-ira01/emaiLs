...
import '/components/atsucess/atsucess_widget.dart';
...
class _EditWidgetState extends State<EditWidget> {
  ...
  void initState() {
    ...
    _model.displayNameTextController1 ??=
        TextEditingController(text: widget.emai);
    _model.displayNameFocusNode1 ??= FocusNode();

    _model.displayNameTextController2 ??=
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await EmailAccountsTable().update(
                        data: {
                          'user_id': currentUserUid,
                          'email': _model.displayNameTextController1.text,
                          'password': _model.displayNameTextController2.text,
                          'created_at':
                      ...
                      safeSetState(() {
                        _model.displayNameTextController1?.clear();
                        _model.displayNameTextController2?.clear();
                      });
