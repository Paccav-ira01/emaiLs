      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: SinginUpWidget.routeName,
              path: SinginUpWidget.routePath,
              builder: (context, params) => SinginUpWidget(),
            ),
            FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Copilot_20250605_002013.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
